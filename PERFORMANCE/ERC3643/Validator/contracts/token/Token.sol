...
contract Token is IToken, AgentRoleUpgradeable, TokenStorage {
    ...
    function transferFrom(
        ...
        if (_tokenIdentityRegistry.contains(_to) && _tokenCompliance.canTransfer(_from, _to, _amount)) {
    ...
    function transfer(address _to, uint256 _amount) public override whenNotPaused returns (bool) {
        ...
        if (_tokenIdentityRegistry.contains(_to) && _tokenCompliance.canTransfer(msg.sender, _to, _amount)) {
    ...
    function mint(address _to, uint256 _amount) public override onlyAgent {
        require(_tokenIdentityRegistry.contains(_to), "Identity is not verified");
